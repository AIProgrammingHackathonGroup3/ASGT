...
// Map<String, List<String>> timetable = (Map<String,
// List<String>>)map.get("timetable");
...
// public static List<String> shapeData(List<Teacher> teachers, List<Student>
// students){
...
// }
// for(String day : timetable.keySet()) {
// List<String> timeset = (List<String>)timetable.get(day);s
// for(String time : timeset) {
